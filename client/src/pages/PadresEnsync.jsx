    ...
    <>
      ...
      <section className="section_4 parallax_section">
        <div className="text_section" id="Prototype">
          <div className="Moodboard_padreEnsync">
                  ...
                  <td className="Empathize">
                    <figure className="imghvr-zoom-out-up">
                      ...
                      <figcaption className="hover-text">
                        <h2>Problem</h2>
                        <h3>
                          The lack of coordination between separated parents
                          makes it difficult to create a harmonious environment
                  ...
                  <td className="Empathize">
                    <figure className="imghvr-zoom-out-up">
                      ...
                      <figcaption className="hover-text">
                        <h2>Objective</h2>
                        <h3>
                          Restore connection and promote harmony in the lives of
                          the children by providing parents with a tool to
                          synchronize their efforts and co-parent
                          collaboratively.
                        </h3>
                      </figcaption>
                    </figure>
                  ...
                  <td className="Empathize">
                    <figure className="imghvr-zoom-out-up">
                      ...
                      <figcaption className="hover-text">
                        <h2>Solution</h2>
                        <h3>
                          Synchronize and simplify co-parenting through an
                          intuitive platform that facilitates the management of
                          expenses and tasks, promoting collaborative parenting
                        </h3>
                      </figcaption>
                    </figure>
                  </td>
            ...
            <tr className="storytelling-image-row">
              <td colSpan="2">
                ...
                <p>
                  ...
                  balm. Upon starting to use the platform, the synchronization
                  of efforts between Ana and Marcos transformed the family
                  environment. Sofia, who had previously experienced discord,
                  witnessed how the magic of PadresEnsync restored the lost
                  connection. Not only did it simplify co-parenting, but it
                  became the key to a new chapter full of tranquility in Sofia's
                  life. Discover the magic of synchronization with PadresEnsync!
                </p>
                <br></br>
                <img
                  src="fliapadres.png"
      ...
      <section className="section_mvp">
        <div className="mvp_container">
          ...
          <div className="mvp">
            ...
            <figure>
              <img
                src="movil_padres.png"
                alt="foto familia"
                className="imghvr-mvp-zoom-up"
              />
              ...
              <figcaption className="hover-text-mvp">
                <div className="card-info-mvp">
                  ...
                  <ul className="box-explication-mvp">
                    ...
                    <li>
                      Cannot delete an expense that is approved or paid,
                      deletion requires approval from both users
                    </li>
                  </ul>
                </div>
                <div className="card-info-mvp">
                ...
                <div className="card-info-mvp">
                  ...
                  <ul className="box-explication-mvp">
                    <li>
                      Display the amount the other user has to pay, indicating
                      if it's 50% for equal sharing
                    </li>
                  </ul>
                </div>
              </figcaption>
              ...
              <figcaption className="hover-text-mvp">
                <div className="card-info-mvp">
                  ...
                  <ul className="box-explication-mvp">
                    ...
                    <li>
                      Define how the payment responsibility will be displayed
                      and how the other user will demonstrate the payment of the
                      outstanding amount. Consider leaving a space to connect
                      with a bank card for direct payment through the bank once
                      accepted.
                    </li>
                  </ul>
                </div>
                <div className="card-info-mvp">
                  ...
                  <ul className="box-explication-mvp">
                    <li>
                      ...
                      expenses, and miscellaneous, for each child. This provides
                      a monthly and yearly control of expenditures
                    </li>
                    <li>
                      Ability to divide the balance between children and show
                      the total for the entire family
                    </li>
                  </ul>
                </div>
              </figcaption>
